    ...
    <div class="container-fluid hero col-12 col-md-12">
        <div class="m_hero " id="m_hero">
            <div class="imagen-logo  justify-content-center text-center">
                <img class="imagenTitulo" src="./imagenes/header.png" width="" height="">
            </div>
        </div>
...
?>
    ...
    <section class="my-5">
        ...
        <!-- <div class="container noticias" id="resultado_busqueda">
            <div class="row">
                <?php foreach($listaNoticias as $noticia) { ?>
                <div class="p-3 col-12 col-md-4 col-lg-4">
                    <div class="card text-center zoom">
                        <img src="./imagenes/<?php echo $noticia['IMAGENES']; ?>" class="card-img-top" width="50"
                            height="300" alt="...">
                        <div class="card-body">
                            <h5 class="card-title fw-bolder text-capitalize titulo-noticia">
                                <?php echo $noticia['TITULO']; ?></h5>
                            <p class="fw-bolder text-primary"><?php echo $noticia['RESUMEN'] ?></p>

                            <button type="button" class="btn btn-outline-warning ">
                                <a href="noticia.php?id=<?php echo $noticia['ID']; ?>"
                                    class=" text-primary fw-bolder  text-decoration-none ">Leer Más</a>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="card mb-3 zoom <?php echo $estilo_actual; ?>">
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title text-center text-capitalize fw-bolder">
        ...
        <div class="container">
                    ...
                    <div class="col-md-4 mb-4 ">
                        <article class="card1">
                            ...
                            <div class="card_content1">
                                    ...
                                    <span class="card_subtitle1 fs-5">El acoso escolar o bullying es la exposición que sufre un niño ...</span>
                                    <p class="card_description1"><a class="text-decoration-none" id="myBtn2">Haz click aqui</a> para leer más sobre el bullyng y sus efectos en los niños ,niñas y adolescentes</p>
                    ...
                    <div class="col-md-4 mb-4  " >
                        <article class="card1">
                            ...
                            <div class="card_content1">
                                    ...
                                    <span class="card_subtitle1 fs-5">El agua es uno de los recursos vitales más importante del mundo....</span>
                                    <p class="card_description1"><a class="text-decoration-none" id="myBtn3"> Haz click aqui</a> para saber más sobre el agua y sus usos en la vida diaria</p>
                    ...
                    <div class="col-md-4 mb-4 ">
                        <article class="card1">
                            ...
                            <div class="card_content1">
                                    ...
                                    <span class="card_subtitle1 fs-5">El animal terrestre más rápido es el guepardo (Acinonyx jubatus)...</span>
                                    <p class="card_description1"><a class="text-decoration-none" id="myBtn4"> Haz click aqui</a> para saber más sobre el animal mas veloz del mundo y su información</p>
                    ...
                    <div class="col-md-4 mb-4 ">
                        <article class="card1">
                            ...
                            <div class="card_content1">
                                    ...
                                    <span class="card_subtitle1 fs-5">Los elefantes pueden comunicarse a largas distancias utilizando infrasonidos</p>
                                    <p class="card_description1"><a class="text-decoration-none" id="myBtn5"> Haz click aqui</a> para saber más sobre los elefantes</p>
                    ...
                    <div class="col-md-4 mb-4 ">
                        <article class="card1">
                            ...
                            <div class="card_content1">
                                    ...
                                    <span class="card_subtitle1 fs-5">Una de las Siete Maravillas del Mundo Antiguo, fue construida hace más de 4,500 años ...</span>
                                    <p class="card_description1"><a class="text-decoration-none" id="myBtn6"> Haz click aqui</a> para saber más sobre la piramide de Guiza </p>
                    ...
                    <div class="col-md-4 mb-4 ">
                        <article class="card1">
                            ...
                            <div class="card_content1">
                                    ...
                                    <span class="card_subtitle1 fs-5">Hay un subglacial que ha estado aislando del mundo por mas de  15 millones de año</span>
                                    <p class="card_description1"><a class="text-decoration-none" id="myBtn7"> Haz click aqui</a> para saber más sobre este subglacial</p>
            ...
            <div id="myModal5" class="modal">
                <div class="modal-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fs-1 text-center text-capitalize">La comunicación de los elefantes</h5>

                        </div>
                        <img src="./imagenes/elefante.jpg" class="card-img-bottom img-fluid" alt="Camera" />
                        <p class="card-text fs-3 pt-2 text-center">
                        Los elefantes pueden comunicarse a largas distancias utilizando infrasonidos, que son sonidos de baja frecuencia que no pueden ser detectados por el oído humano. Estos infrasonidos pueden viajar hasta 6 millas (10 km) a través del aire y hasta 20 millas (32 km) a través del suelo. Los elefantes usan estos sonidos para comunicarse entre sí, incluso a través de obstáculos como montañas y bosques. Además, se ha demostrado que los elefantes pueden distinguir entre diferentes tipos de infrasonidos, lo que sugiere que pueden usar estos sonidos para comunicar información específica, como la ubicación de fuentes de agua o la presencia de depredadores.
                     </p>
            ...
            <div id="myModal6" class="modal">
                <div class="modal-content">
                    ...
                    <div class="card">
                        ...
                        <p class="card-text fs-3 pt-2 text-center">
                        La Gran Pirámide de Guiza, una de las Siete Maravillas del Mundo Antiguo, fue construida hace más de 4,500 años y es la estructura más antigua del mundo que todavía se mantiene en pie. Los antiguos egipcios la construyeron como tumba para el faraón Khufu, y se necesitaron alrededor de 20 años y más de 2 millones de bloques de piedra para completarla. La altura original de la Gran Pirámide era de 146 metros, pero actualmente mide 138 metros debido a la erosión. La Gran Pirámide es una obra de ingeniería impresionante y su construcción sigue siendo un misterio para los arqueólogos y científicos modernos.
                      </p>
            ...
            <div id="myModal7" class="modal">
                <div class="modal-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fs-1 text-center text-capitalize">En la Antártida, hay un lago subglacial llamado lago Vostok</h5>

                        </div>
                        <img src="./imagenes/antartida.jpg" class="card-img-bottom img-fluid" alt="Camera" />
                        <p class="card-text fs-3 pt-2 text-center">
                        En la Antártida, hay un lago subglacial llamado lago Vostok que ha estado aislado del mundo exterior durante más de 15 millones de años. Debido a que el lago está cubierto por más de 2 millas (3 km) de hielo, los científicos creen que podría haber formas de vida únicas que no se han encontrado en ningún otro lugar del planeta. En 2012, los científicos lograron perforar a través del hielo y tomar muestras del agua del lago para su análisis. El estudio de estas muestras podría ayudar a los científicos a comprender cómo las formas de vida pueden sobrevivir en ambientes extremos y podría tener importantes implicaciones para la búsqueda de vida en otros planetas.
                      </p>
