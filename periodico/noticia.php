...
<body class="hidden">
    ...
    <div class="container-fluid p-6 mx-auto" id="noticia-container">
        ...
        <p class="fs-3 lh-base text-center contenido parrafo"><?php echo $parte1; ?></p>
        <img id="Noticia2" class="img-fluid mt-2 pb-2" src="./imagenes/<?php echo $imagen2; ?>">
        <p class="fs-3 text-center text-center parrafo"><?php echo $parte2; ?></p>
        <?php else: ?>
        <?php if (isset($imagenes)) :?>
        <p class="fs-3 lh-base text-center contenido parrafo"><?php echo $contenido; ?></p>
        <?php endif;?>
        <?php endif; ?>
